...
(
    ...
    resetprop -n dalvik.vm.background-dex2oat-cpu-set "$cpu_mask" 2>/dev/null || setprop dalvik.vm.background-dex2oat-cpu-set "$cpu_mask"
    resetprop -n dalvik.vm.background-dex2oat-threads "$thread_count" 2>/dev/null || setprop dalvik.vm.background-dex2oat-threads "$thread_count"
) &
